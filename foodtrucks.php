...
<body data-theme="night">
  ...
  <div class="pt-[60px] px-10 flex flex-wrap justify-center gap-10 pb-10">
    <div class="card lg:card-side bg-base-200 shadow-xl p-2 w-[600px] 2xl:w-2/5 mt-10">
      <img src="img/charlottes.avif" onerror="this.src='img/charlottes.png'" alt="Album" class="rounded-xl object-cover md:w-1/2 lg:w-1/2 mx-auto md:mt-10 lg:mt-0"/>
    ...
    <div class="card lg:card-side bg-base-200 shadow-xl p-2 w-[600px] 2xl:w-2/5 mt-10">
      <img src="img/brightside.avif" onerror="this.src='img/brightside.png'" alt="Album" class="rounded-xl object-cover md:w-1/2 lg:w-1/2 mx-auto md:mt-10 lg:mt-0"/>
      <div class="card-body flex justify-center items-center text-center lg:w-1/2">
        <div>
    ...
    <div class="card lg:card-side bg-base-200 shadow-xl p-2 w-[600px] 2xl:w-2/5 mt-10">
        <img src="img/mommaperez.avif" onerror="this.src='img/mommaperez.jpg'" alt="Album" class="rounded-xl object-cover md:w-1/2 lg:w-1/2 mx-auto md:mt-10 lg:mt-0"/>
        <div class="card-body flex justify-center items-center text-center lg:w-1/2">
          <div>
