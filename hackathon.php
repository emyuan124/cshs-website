...
<body class="text-center lg:text-left">
  <?php include $_SERVER["DOCUMENT_ROOT"].'/titlebar.php'; ?>
    ...
    <div class="logo py-12 lg:py-32 bg-base-100">
      <div class="logo-content flex-col lg:flex-row gap-6 lg:gap-24">
        <img src="img/hero.avif" onerror="this.src='img/logo.png'" class="max-md:w-[90%] max-w-sm rounded-lg shadow-2xl" />
        <div>
