...
<div class="logo py-12 lg:py-32 bg-base-100">
    <div class="logo-content flex-col lg:flex-row-reverse gap-6 lg:gap-24">
      <img src="img/hero2.avif" onerror="this.src='img/logo.png'" class="max-md:w-[90%] max-w-sm rounded-lg shadow-2xl" />
      <div>
        <h2 class="text-5xl font-bold">What is a Hackathon?</h2>
