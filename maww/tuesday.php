    ...
    <div class="hero py-12 lg:py-32 bg-base-100">
      <div class="hero-content flex-col lg:flex-row gap-6 lg:gap-24">
        ...
        <div>
          ...
          <p>Come to BJ's for a fun night of food and fundraising! Enter the code APR752 during online checkout or bring a physical/digital flyer to donate your proceeds to Make-A-Wish Colorado! The address is <i>2670 E Harmony Rd</i></p>
        </div>
      </div>
    </div>
