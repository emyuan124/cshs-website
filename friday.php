...
<body data-theme="night" class="text-center lg:text-left">
  ...
  <div class="hero h-[450px] pt-[60px]" style="background-image: url(img/maww_friday_banner.png);">
  ...
  <div class="hero py-12 lg:py-32 bg-base-100">
      <div class="hero-content flex-col lg:flex-row gap-6 lg:gap-12">
        <img src="img/maww_friday_hero.avif" onerror="this.src='img/maww_friday_hero.png'" class="max-md:w-[90%] max-w-sm rounded-lg shadow-2xl" />
        <div>
